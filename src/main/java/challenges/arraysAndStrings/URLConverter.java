...
public class URLConverter {
    public String urlify(String url, int length) {
        ...
        final String percent20 = "%20";
        String urlWithPercent20 = urlAfterTrim.replaceAll(" ", percent20);
        if (urlWithPercent20.length() == length) {
            return urlWithPercent20;
        }
        if (urlWithPercent20.length() + percent20.length() == length) {
            return urlWithPercent20 + percent20;
        }
        return null;
    }
